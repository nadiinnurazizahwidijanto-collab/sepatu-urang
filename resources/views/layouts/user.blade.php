...
<head>
    ...
    <title>Sapatu-urang - {{ $titlePage ?? 'Luxury Footwear' }}</title>
  ...
  <nav class="navbar navbar-expand-lg shadow-sm sticky-top">
      <div class="container">
        <a class="navbar-brand fw-bold" href="{{ route('home') }}">
            <img src="{{ asset('img/unnamed-removebg-preview.png') }}" alt="Logo" width="40px" class="me-2">
            SAPATU-URANG
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarMain">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
            <li class="nav-item"><a class="nav-link" href="{{ route('home', ['category_id' => 1]) }}">Men</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('home', ['category_id' => 2]) }}">Women</a></li>
            <li class="nav-item"><a class="nav-link" href="{{ route('home', ['category_id' => 3]) }}">Kids</a></li>
            ...
            @auth
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu border-0 shadow-sm rounded-0">
                        <li><a class="dropdown-item small fw-bold" href="{{ route('admin.orders') }}">PESANAN MASUK</a></li>
                        <li><a class="dropdown-item small fw-bold" href="{{ route('admin.dashboard') }}">KELOLA KATALOG</a></li>
                    </ul>
                </li>
                @endif
            @endauth
          ...
          <div class="d-flex align-items-center gap-3">
            @guest
              <a href="{{ route('login') }}" class="nav-link p-0" title="Login">
                <i class="fa-solid fa-user-lock me-1"></i> LOGIN
              </a>
            @else
              <a href="{{ route('order') }}" class="text-dark position-relative" title="My Orders"><i class="fa-solid fa-bag-shopping fs-5"></i></a>
              <a href="{{ route('cart') }}" class="text-dark position-relative" title="Shopping Cart"><i class="fa-solid fa-cart-shopping fs-5"></i></a>
