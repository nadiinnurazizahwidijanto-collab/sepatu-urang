...
<?php if(auth()->guard()->check()): ?>
    ...
    <div class="floating-cart" data-aos="fade-left" data-aos-offset="0">
        <a href="<?php echo e(route('cart')); ?>" class="cart-box position-relative">
    ...
    <div class="container-fluid">
        <div class="row align-items-center">
            ...
            <div class="col-lg-7 hero-image-box">
                <img src="<?php echo e(asset('img/sendalsepatu_tradisional.png')); ?>" class="floating-main" alt="Iconic Piece" data-aos="zoom-in" data-aos-duration="2000">
            </div>
        </div>
    </div>
...
<section class="product-container" id="products">
    <div class="container">
        ...
        <div class="row g-5">
            ...
            <div class="col-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                <a href="<?php echo e(url('detail/'.$product->id)); ?>" class="text-decoration-none text-dark product-card d-block">
                    <div class="product-img-wrapper">
                        <img src="<?php echo e(asset('img/'.$product->image_path)); ?>" alt="<?php echo e($product->name); ?>">
                    </div>
                    <div class="text-center">
                        <div class="prod-meta"><?php echo e($product->category->name); ?></div>
                        <h3 class="prod-name"><?php echo e($product->name); ?></h3>
                        <p class="prod-price">Rp <?php echo e(number_format($product->price, 0, ',', '.')); ?></p>
                    </div>
                </a>
            </div>
...
<?php echo $__env->make('layouts.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\sepatuku\resources\views/user/home.blade.php ENDPATH**/ ?>