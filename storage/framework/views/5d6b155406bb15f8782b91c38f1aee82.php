...
<head>
    ...
    <title>sapatu-urang - <?php echo e($titlePage); ?></title>
...
style="font-family: 'Poppins', sans-serif; background: linear-gradient(to right, #a9604e, #7f3d0b);">
    ...
    <div class="col-11 col-lg-10 row bg-white p-0 rounded-3 overflow-hidden shadow" style="height: 80vh;">
        <div class="col-6 p-0 d-none d-lg-block" style="background-image: url('<?php echo e(asset('img/log.png')); ?>'); background-size: cover; background-position: center;"></div>
...
unset($__errorArgs, $__bag); ?>
            <form class="container" action="<?php echo e(route('authenticate')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
                ...
                <p>Don't have an account? <a href="<?php echo e(route("register")); ?>" class="fw-medium text-decoration-none text-dark">Register</a></p>
            </form>
        </div>
    </div>
...
<?php /**PATH C:\laragon\www\sepatuku\resources\views/login.blade.php ENDPATH**/ ?>