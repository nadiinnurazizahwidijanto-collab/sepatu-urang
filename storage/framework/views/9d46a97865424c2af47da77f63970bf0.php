...
<head>
    ...
    <title>KASUTKU - <?php echo e($titlePage); ?></title>
...
style="background: linear-gradient(to right, #a9604e, #7f3d0b);">

    <div class="col-11 col-lg-10 row bg-white p-0 rounded-3 overflow-hidden shadow" style="height: 80vh;">
        <div class="col-6 p-0 d-none d-lg-block" style="background-image: url('<?php echo e(asset('img/reg.png')); ?>'); background-size: cover;"></div>
        <div class="col-12 col-lg-6 d-flex justify-content-center align-items-center flex-column">
            <h1>Register</h1>
            <form class="container" action="<?php echo e(route('storeUser')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('email')); ?>" id="exampleInputEmail1" name="email" required>
...
unset($__errorArgs, $__bag); ?>" id="password" name="password" aria-describedby="passwordHelp" required>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p>Already have an account? <a href="<?php echo e(route("login")); ?>" class="fw-medium text-decoration-none text-dark">Login</a></p>
            </form>
        </div>
    </div>

<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-C6RzsynM9kWDrMNeT87bh95OGNyZPhcTNXj1NW7RuBCsyN/o0jlpcV8Qyq46cDfL" crossorigin="anonymous"></script>
<script src="<?php echo e(asset('js/showPass.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\laragon\www\sepatuku\resources\views/register.blade.php ENDPATH**/ ?>